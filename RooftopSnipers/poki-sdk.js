(() => {
	...
	var t = function (e, t, n, o) {
		...
		c = new ((function () {
			...
			return (
				(e.prototype.enqueue = function (e, t, n, o) {
					var i = {
						fn: e,
						args: t || [],
						resolveFn: n,
	...
	if (
		...
		try {
			...
			u || ((u = crypto.randomUUID()), 'GB' !== o('country') && localStorage.setItem('poki_events_user_id', u));
			var s = o('game_id'),
				l = o('game_version_id');
			if (!s || !l) {
				throw 1;
			...
			window.PokiSDK.measure = function (e, t, n) {
				...
				(function (e, t, n) {
					return (
						('game' === e && 'loading' === t && 'start' === n) ||
						('game' === e && 'loading' === t && 'complete' === n) ||
						('game' === e && 'launch' === t && '' === n) ||
						('game' === e && 'meaningful' === t && 'first' === n) ||
						('tutorial' === e && 'start' === t && '' === n) ||
						('tutorial' === e && 'complete' === t && '' === n) ||
						!('progress' !== e || 'start' !== t || !f(n)) ||
						!('progress' !== e || 'complete' !== t || !f(n)) ||
						!('progress' !== e || 'fail' !== t || !f(n)) ||
						('rewarded' === e && 'visible' === t) ||
						('rewarded' === e && 'click' === t) ||
						!('rewarded' !== e || 'start' !== t || !f(n)) ||
						!('rewarded' !== e || 'complete' !== t || !f(n)) ||
						!('midroll' !== e || 'start' !== t || !f(n)) ||
						!('midroll' !== e || 'complete' !== t || !f(n)) ||
						'custom' === e
					);
				})(e, (t = void 0 === t ? '' : ''.concat(t)), (n = void 0 === n ? '' : ''.concat(n)))
					? ((window.pokiMeasureBuildin = true))
					: console.warn(
							'%cPOKI:%c measure() event not allowed: '.concat(e, '-').concat(t, '-').concat(n),
							'font-weight: bold',
							''
					  );
			};
